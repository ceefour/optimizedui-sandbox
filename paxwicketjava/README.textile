...
6. Karaf Web Console is good for administration

bc. feature:install -v webconsole

Access from http://localhost:8181/system/console/bundles with user karaf password karaf

7. Now you have a personalized application server. Better zip the karaf directory
...
Should show Deployed on /hello . Try:

http://localhost:8181/hello/dummy
